...
use utils::{
    config::{
        ...
        default_compact_sleep_interval, default_compact_timeout, default_curp_db_dir,
        default_follower_timeout_ticks, default_gc_interval, default_heartbeat_interval,
        default_initial_retry_timeout, default_log_entries_cap, default_log_level,
        default_max_retry_timeout, default_metrics_enable, default_metrics_path,
