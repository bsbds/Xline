use xline_client::{
    clients::lease::{
        LeaseClient, LeaseGrantRequest, LeaseKeepAliveRequest, LeaseRevokeRequest,
...
async fn get_cluster_client() -> Result<(Cluster, LeaseClient)> {
