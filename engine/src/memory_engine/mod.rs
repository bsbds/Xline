...
pub(crate) use self::transaction::MemoryTransaction;
...
pub struct MemoryEngine {
    ...
    pub(super) inner: Arc<RwLock<HashMap<String, MemoryTable>>>,
}
...
impl StorageOps for MemoryEngine {
    fn write(&self, _op: WriteOperation<'_>, _sync: bool) -> Result<(), EngineError> {
        todo!()
    }
